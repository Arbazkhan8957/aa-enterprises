...
async function run() {
  ...
  const newRelays = [
    generateRelay('LRD 14', '7 - 10 A'),
    generateRelay('LRD 16', '9 - 13 A'),
    generateRelay('LRD 21', '12 - 18 A'),
    generateRelay('LRD 22', '16 - 24 A'),
    generateRelay('LRD 32', '23 - 32 A'),
    generateRelay('LRD 35', '30 - 38 A'),
    generateRelay('LRD 340', '30 - 40 A'),
    generateRelay('LRD 350', '37 - 50 A'),
  ];
  ...
  console.log('Successfully appended 8 more Schneider LRD Relays!');
}
