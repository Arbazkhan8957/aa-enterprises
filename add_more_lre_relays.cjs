...
async function run() {
  ...
  const newRelays = [
    generateRelay('LRE 06', '1 - 1.6 A'),
    generateRelay('LRE 07', '1.6 - 2.5 A'),
    generateRelay('LRE 08', '2.5 - 4 A'),
    generateRelay('LRE 10', '4 - 6 A'),
    generateRelay('LRE 12', '5.5 - 8 A'),
  ];
  ...
  console.log('Successfully appended 5 more Schneider LRE Relays!');
}
