export const globalHeroSlides = [
  {
    ...
    features: ["PREMIUM QUALITY", "RELIABLE PERFORMANCE", "COMPETITIVE PRICING", "TECHNICAL SUPPORT"],
    theme: "light"
  },
  {
    isBanner: true,
    ...
    features: ["100% GENUINE", "WIDE RANGE", "FAST DELIVERY", "24/7 SUPPORT"],
    theme: "light"
  },
  {
    isBanner: true,
    ...
    features: ["100% GENUINE", "FAST DELIVERY", "COMPETITIVE PRICING", "TECH SUPPORT"],
    theme: "dark"
  }
];
