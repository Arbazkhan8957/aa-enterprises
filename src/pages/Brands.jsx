...
const BrandLogo = ({ brand, className, smallFallback = false }) => {
  ...
  const src = brand.logo.includes('/') ? brand.logo : `/aa-enterprises/images/${brand.logo.toLowerCase()}.png`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-center">
            ...
            <div className="relative h-[300px] sm:h-[500px] rounded-[3rem] overflow-hidden border border-gray-700 shadow-2xl group">
               <img src="/aa-enterprises/images/lc1e_family.jpg" alt="Technical Support" className="w-full h-full object-cover opacity-60 group-hover:scale-110 transition-transform duration-1000 mix-blend-luminosity group-hover:mix-blend-normal" />
